...
const SCHEMA = `
  ...
  CREATE TABLE IF NOT EXISTS raffle_entries (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    event_id INTEGER NOT NULL REFERENCES raffle_events(id) ON DELETE CASCADE,
    name TEXT NOT NULL,
    email TEXT NOT NULL,
    phone TEXT,
    heard_from TEXT,
...
export async function ensureSchema(): Promise<void> {
  ...
  const migrations = [
    ...
    'ALTER TABLE open_houses ADD COLUMN price INTEGER',
    'ALTER TABLE open_houses ADD COLUMN beds INTEGER',
    'ALTER TABLE open_houses ADD COLUMN baths REAL',
    'ALTER TABLE open_houses ADD COLUMN sqft INTEGER',
    'ALTER TABLE open_houses ADD COLUMN description TEXT',
    'ALTER TABLE open_house_signins ADD COLUMN lead_score INTEGER NOT NULL DEFAULT 0',
